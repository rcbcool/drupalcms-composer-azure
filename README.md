...
1. Run `rm composer.lock` & `rm -rf vendor`
2. Run `composer update drupal/core --with-dependencies`, then have the drush commands `drush updatedb` & `drush cache:rebuild` executed.
